...
```
ggrep "start" transaction_data_daily_event_log_20190129.dat
```
...
```
ggrep -c "start" transaction_data_daily_event_log_20190129.dat
```
...
```
ggrep -n "fail" transaction_data_daily_event_log_20190129.dat
```
